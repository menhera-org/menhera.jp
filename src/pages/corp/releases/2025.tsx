...
export default function ReleasesIndex() {
    return <div>
        <Head>
            <title>プレスリリース (2025) | 生活情報基盤研究機構 (Menhera.org)</title>
        </Head>
        <h1>プレスリリース</h1>
        <Markdown>{`
...
日本時間2025年9月7日21時からオンラインで、2025年第1回臨時総会を招集しました。投票できるのは法人の正構成員ですが，誰でも傍聴できます。正構成員の方はリアルタイムで参加できない場合は事前オンライン投票(投票券は送信済みです)にご協力ください。
