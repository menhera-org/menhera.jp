...
export default function ContactUs() {
    return <div>
        ...
        <h1>お問い合わせ</h1>
        <p><a href="https://docs.google.com/forms/d/e/1FAIpQLSeYkYU4RA5oR5XLXMrFXobNvc0JlwA1M2Vhv8Ne03NuSFjU0A/viewform">匿名ご意見フォーム</a></p>
        <h2>電子メール</h2>
        ...
        <h2>電話</h2>
        <p>Tel: 029-828-4147 (代表) (「＊」につづけて内線番号を入力することで直接内線 (Menhera 電話) にかけることができます)</p>
        <p>FAX: 029-828-4147 (同番号)</p>
