    ...
    return <>
        <div className={styles.page_footer_branding}>
            <div className={styles.page_footer_branding_content}>
                <h5>商標について</h5>
                <div>「Menhera.org」は DNS ドメイン名に由来する私たちの商標で、もともとその名のもとに私たちは集まりました。なので、この商標は日本語のネットスラングとは現在ではあまり関係がありません。これは歴史的理由によるものです。</div>
        ...
        <div className={styles.page_footer}>
            <div className={styles.page_footer_content}>
                ...
                <p>© {(new Date).getFullYear()} 一般社団法人生活情報基盤研究機構。他に表記が無い限り，コンテンツは <a href="https://creativecommons.org/licenses/by/4.0/">CC-BY-4.0</a> ライセンスのもとで利用可能です。(Menhera.org ロゴなど商標を除く)</p>
