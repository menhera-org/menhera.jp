    ...
    return <>
        ...
        <div className={styles.page_footer}>
            <div className={styles.page_footer_content}>
                ...
                <p>© {(new Date).getFullYear()} 一般社団法人生活情報基盤研究機構。他に表記が無い限り，コンテンツは <a href="https://creativecommons.org/licenses/by/4.0/">CC-BY-4.0</a> ライセンスのもとで利用可能です。(「Menhera M」ロゴなど商標を除く) Menhera®、Menhera.org、「Menhera M」ロゴは一般社団法人生活情報基盤研究機構が商標として使用しております。Menhera®は一般社団法人生活情報基盤研究機構の登録商標です (<a href="https://www.j-platpat.inpit.go.jp/c1801/TR/JP-2025-048650/40/ja">登録第6945732号</a>)。</p>
